  ...
  return (
    <div className="hero-filter">
      <Tabs defaultActiveKey="residential">
        <Tab eventKey="residential" title="Residential for Sale">
          <FilterInputs currentCity={currentCity} setCurrentCity={setCurrentCity} />
        </Tab>
        <Tab eventKey="commercial" title="Commercial for Sale">
          <FilterInputs currentCity={currentCity} setCurrentCity={setCurrentCity} />
        </Tab>
        <Tab eventKey="land" title="Land for Sale">
          <FilterInputs currentCity={currentCity} setCurrentCity={setCurrentCity} />
        </Tab>
        <Tab eventKey="multiple" title="Multiple Units for Sale">
          <FilterInputs currentCity={currentCity} setCurrentCity={setCurrentCity} />
        </Tab>
      </Tabs>
    </div>
