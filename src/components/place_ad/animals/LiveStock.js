...
const LiveStockForm = function () {
  ...
  return (
    <>
      <h4 className="text-center my-3">Let&apos;s know about your live stock</h4>
      <form className="w-50 mx-auto my-5 px-4" onSubmit={(e) => e.preventDefault()}>
        <h5>Overview</h5>
        <Input title="Title*" required />
        <DropdownMenu title="Type*" fw="Cows" options={['Bulls', 'Buffalos', 'Sheep', 'Goats', 'Other']} />
